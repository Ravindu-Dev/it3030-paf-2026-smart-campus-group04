...
export default function Facilities({ standalone = false }) {
    const { user } = useAuth();
...
function FacilityCard({ facility }) {
    ...
    const canBook = user?.role !== 'ADMIN' && isActive;

    return (
        <div className="group bg-slate-800/60 backdrop-blur-sm border border-slate-700/50 rounded-2xl overflow-hidden hover:border-blue-500/30 hover:shadow-lg hover:shadow-blue-500/5 transition-all duration-300">
