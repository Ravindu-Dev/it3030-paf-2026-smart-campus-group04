                                    ...
                                    <div className="flex sm:flex-col items-center sm:items-end gap-3 flex-shrink-0 pt-2 sm:pt-0">
                                        {ticket.status !== 'CLOSED' && ticket.status !== 'REJECTED' && !ticket.assignedTechnicianId && (
                                            <button
                                                ...
                                                className="w-full sm:w-auto px-5 py-2.5 rounded-xl text-sm font-bold transition-all flex justify-center items-center gap-2 shadow-sm bg-gradient-to-r from-blue-500 to-indigo-600 text-white hover:from-blue-400 hover:to-indigo-500 shadow-[0_0_15px_rgba(59,130,246,0.3)] hover:shadow-[0_0_20px_rgba(59,130,246,0.4)] border border-blue-400/30 cursor-pointer"
                                            >
