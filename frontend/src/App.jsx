...
function App() {
  ...
  const hideFooter = location.pathname === '/dashboard' || location.pathname === '/attendance/scan' || (isPrivilegedUser && (isFacilityRoute || isBookingRoute || isTicketRoute || isTransportRoute)) || isTrackingRoute;
  const hideNavbar = location.pathname === '/dashboard' || location.pathname === '/attendance/scan' || (isPrivilegedUser && (isFacilityRoute || isBookingRoute || isTicketRoute || isTransportRoute)) || isTrackingRoute;
